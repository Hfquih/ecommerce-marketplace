...
const payement=require('./route/payement')
const support=require('./route/contact')
const connect=require('./connect/connectDb')
const notFound=require('./middlwear/notFound')
const errorHandler=require('./middlwear/errorHandler')
...
app.use('/api/v1/payement',payement)
